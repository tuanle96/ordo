...
| Phase 07 — iOS form editors & list browsing improvements | ✅ Complete | Many2many editable tags shipped; browse table mode + sort landed; chatter now supports thread read, post-note, follower self-follow/unfollow, activity scheduling, and activity completion with lazy-load UI + adapter delegation |
